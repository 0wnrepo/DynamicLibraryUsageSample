...
//#ifndef DYNAMICLIBRARYDLLONLYSAMPLE_DLL_H
//#define DYNAMICLIBRARYDLLONLYSAMPLE_DLL_H
#pragma once

#ifdef DYNAMICLIBRARYDLLONLYSAMPLE_EXPORTS // add this define-value to "Properties -> C\C++ -> Preprocessor Definitions" and add "DYNAMICLIBRARYDLLONLYSAMPLE_EXPORTS;"
#define FUNCSDLL_API __declspec(dllexport)
#else   
// (!!!) With the next 2 Lines we force the App-Project to use .LIB-File
//#pragma message("automatic link to DynamicLibraryDllOnlySample.LIB")
//#pragma comment(lib, "DynamicLibraryDllOnlySample.lib")
...
//#endif // DYNAMICLIBRARYDLLONLYSAMPLE_DLL_H
