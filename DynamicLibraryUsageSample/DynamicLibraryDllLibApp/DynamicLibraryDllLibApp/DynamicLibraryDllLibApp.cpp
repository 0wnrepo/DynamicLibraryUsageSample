...
//#include "..\..\DynamicLibraryDllLibSample\DynamicLibraryDllLibSample\DynamicLibraryDllLibSample.h" //use this line if you have lost .SLN-File for this Project
#include "DynamicLibraryDllLibSample.h"

#ifdef UNICODE //UNICODE is used by Windows headers //_UNICODE is used by C-runtime / MFC headers.
#define OUR_DLL L"DynamicLibraryDllLibSample.dll"
#else
#define OUR_DLL "DynamicLibraryDllLibSample.dll"
#endif
...
//*/
	...
	// (-) It's possible to use instances ONLY of Classes but NOT Templates like this:
